#include "TestGripPipeline.h"

namespace grip {

TestGripPipeline::TestGripPipeline() {
}
/**
* Runs an iteration of the pipeline and updates outputs.
*/
void TestGripPipeline::Process(cv::Mat& source0){
	//Step RGB_Threshold0:
	//input
	cv::Mat rgbThresholdInput = source0;
	double rgbThresholdRed[] = {80.26079136690647, 255.0};
	double rgbThresholdGreen[] = {0.0, 151.969696969697};
	double rgbThresholdBlue[] = {36.690647482014384, 255.0};
 ...
 */
cv::Mat* TestGripPipeline::GetRgbThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* TestGripPipeline::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* TestGripPipeline::GetFilterContoursOutput(){
	 ...
	 */
	void TestGripPipeline::rgbThreshold(cv::Mat &input, double red[], double green[], double blue[], cv::Mat &output) {
	 ...
	 */
	void TestGripPipeline::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void TestGripPipeline::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
